...
| [**Lead Generation (Apify)**](/workflows/lead-generation) | Scrapes Google Maps via Apify based on category/location/rating, enriches leads by scraping websites for emails, phones, and social links, then logs everything to a Google Sheet. | Web Form (n8n Form Trigger) | Apify, Google Sheets, HTTP Request |
